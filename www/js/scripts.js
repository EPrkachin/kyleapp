	...
	for (var i = 0; i < len; i++) {
		...
		switch(wordArray[i]){
			...
			case "me": 				
				...
				// Background change
				document.getElementById('kyleBackground').style.backgroundImage = "url('images/img12.jpg')";
				break;
			...
			case "my": 				
				...
				// Background change
				document.getElementById('kyleBackground').style.backgroundImage = "url('images/meagain.jpg')";
				break;
